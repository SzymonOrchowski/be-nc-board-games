...
```http
GET /api/categories     VVV
GET /api/reviews/:review_id     VVV 
PATCH /api/reviews/:review_id     VVV 
GET /api/reviews    VVV
GET /api/reviews/:review_id/comments     VVV
POST /api/reviews/:review_id/comments     VVV
